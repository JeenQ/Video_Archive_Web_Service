...
echo n | xcopy image C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\image /e /h /k
mkdir C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\resources
echo n | xcopy resources C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\resources /e /h /k
