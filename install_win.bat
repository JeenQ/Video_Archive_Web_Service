...
REM install bitnami
powershell "(new-object Net.WebClient).DownloadFile('https://bitnami.com/redirect/to/163844/bitnami-wampstack-5.6.32-0-windows-x64-installer.exe', 'Video_Archive_Web_Service/bitnami-wampstack-5.6.32-0-windows-x64-installer.exe')"
Video_Archive_Web_Service\bitnami-wampstack-5.6.32-0-windows-x64-installer.exe
...
xcopy Video_Archive_Web_Service\archive C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\archive /e /h /k
mkdir C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\image
xcopy Video_Archive_Web_Service\image C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\image /e /h /k
mkdir C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\resources
xcopy Video_Archive_Web_Service\resources C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\resources /e /h /k
copy Video_Archive_Web_Service\index.html C:\Bitnami\wampstack-5.6.32-0\apache2\htdocs\index.html
copy Video_Archive_Web_Service\php.ini C:\Bitnami\wampstack-5.6.32-0\php\php.ini
